  ...
  Future<void> _publicarMaterial() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Material publicado com sucesso!'), backgroundColor: Colors.green),
        );
      }
    } catch (e) {
      if (mounted) {
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              _arquivoSelecionado?.name ?? 'Selecionar Ficheiro (PDF, Vídeo, Imagem)',
                              style: TextStyle(color: _arquivoSelecionado == null ? Colors.grey : Colors.black),
                            ),
                          ),
                        ],
                      ),
                  ...
                  ElevatedButton(
                    ...
                    child: const Text('Publicar Material', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ),
